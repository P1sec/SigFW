...
public class DTLSOverDatagram {
     ...
     */
    private static String pathToStores = "./";
    private static String keyStoreFile = "keystore";
    private static String trustStoreFile = "truststore";
    private static String passwd = "keystore";
    ...
    //SSLEngine engine_server;
    //SSLEngine engine_client;
    ...
    List<DatagramPacket> produceApplicationPackets(
        ...
        /*    // test backward decryption
            appNet.flip();
            byte[] ba_test = new byte[appNet.remaining()];
            appNet.get(ba_test);
            ByteBuffer netBuffer = ByteBuffer.wrap(ba_test, 0, ba_test.length);
            ByteBuffer recBuffer = ByteBuffer.allocate(BUFFER_SIZE);
            SSLEngineResult rs_test = engine_server.unwrap(netBuffer, recBuffer);
        */
