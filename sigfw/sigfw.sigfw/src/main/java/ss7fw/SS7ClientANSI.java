...
//import org.mobicents.protocols.ss7.tcapAnsi.asn.ApplicationContextName;
 ...
 */
public class SS7ClientANSI extends AbstractSctpBase implements ManagementEventListener, MAPDialogListener {

    private static Logger logger = Logger.getLogger(SS7ClientANSI.class);
    ...
    private void initMAP() throws Exception {
        ...
        // ANSI TCAP
        this.tcapStack = new TCAPStackImpl("TCAPStack", this.sccpProvider, SSN);
        ...
        // non compatible cast
        //this.mapStack = new MAPStackImpl("SctpClientMAP", (org.mobicents.protocols.ss7.tcap.api.TCAPProvider) this.tcapStack.getProvider());
        //
    ...
    public static void main(String args[]) {
        ...
        final SS7ClientANSI client = new SS7ClientANSI();
        ...
        try {
            ...
            // TCAP ANSI
            // Reference source code https://github.com/RestComm/jss7/blob/master/tcap-ansi/tcap-ansi-impl/src/test/java/org/restcomm/protocols/ss7/tcapAnsi/ClientTest.java
            Thread.sleep(1000);
            ComponentPrimitiveFactory cpFactory = client.tcapProvider.getComponentPrimitiveFactory();

            // create some INVOKE
            Invoke invoke = cpFactory.createTCInvokeRequestLast();
            Dialog clientDialog = client.tcapProvider.getNewDialog(callingParty, calledParty);
            invoke.setInvokeId(clientDialog.getNewInvokeId());
            ...
            ApplicationContext _acn = client.tcapProvider.getDialogPrimitiveFactory().createApplicationContext(_ACN_);
            TCQueryRequest tcbr = client.tcapProvider.getDialogPrimitiveFactory().createQuery(clientDialog, true);
            tcbr.setApplicationContextName(_acn);
